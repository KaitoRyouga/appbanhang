...
import { Platform, DeviceEventEmitter, NativeModules, NativeEventEmitter, Button, Dimensions, Text, View, Image, StyleSheet, Alert } from 'react-native';
          ...
          renderItem={({ item, index }) => (
            <View style={styles.ProductContainer} key={item.product.id}>
              <View style={styles.ImgViewProduct}>
                <Image
                  source={{
                    uri: `http://192.168.1.101/app/images/product/${item.product.images[0]}`,
                  }}
